...
if(isset($_REQUEST['worker'])) {
  ...
  $endLoc = $_REQUEST['endloc'];  // location of the target [x,y] at the end of the task (target hit)
  //$stLocMouse = $_REQUEST['startlocm'];  // location of mouse pointer [x,y] at start of task (target appears, or prior target hit)
  //$endLocMouse = $_REQUEST['endlocm'];  // location of the mouse pointer [x,y] at the end of the task (target hit)
